...
def create_args():
    ...
    # --- Input paths ---
    config_specification.add_argument('--input_path', default="/home/wang/Documents/PhD_Tracking/datasets/inD-dataset-v1.0/data/",
                                      help="Dir with track files", type=str)
    config_specification.add_argument('--recording_name', default="20",
...
def read_exitD(input_root_path, num_str):
    recording_name = num_str
